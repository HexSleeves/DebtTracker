			...
			<Card>
				...
				<CardContent>
					<div className="grid grid-cols-2 gap-4 md:grid-cols-4">
						...
						<div className="space-y-2">
							<div className="flex h-20 items-center justify-center rounded-lg bg-error">
				...
				<CardContent>
					<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
						<div className="space-y-4">
							<div className="h-4 rounded-full bg-gradient-primary" />
							<div className="h-4 rounded-full bg-gradient-success" />
							<div className="h-4 rounded-full bg-gradient-warning" />
							<div className="h-4 rounded-full bg-gradient-error" />
						</div>
						<div className="space-y-4">
							...
							<div className="rounded-lg bg-gradient-success p-4">
