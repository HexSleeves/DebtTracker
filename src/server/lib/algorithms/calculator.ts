 ...
 */
export function calculateTotalMinimumPayments(debts: DebtCalculationInput[]): number {
 ...
 */
export function calculateWeightedAverageInterestRate(debts: DebtCalculationInput[]): number {
