import type { DebtCalculationInput } from "./calculator";
...
function simulateAvalanchePayments(sortedDebts: DebtCalculationInput[], monthlyBudget: number) {
...
function calculateMinimumPaymentInterest(debts: DebtCalculationInput[]): number {
