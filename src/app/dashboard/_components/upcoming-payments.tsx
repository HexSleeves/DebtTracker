			...
			<Card className="hover-lift">
				<CardHeader className="border-b bg-gradient-to-r from-muted/50 to-transparent">
					<CardTitle className="flex items-center gap-2">
						...
						<div>
							<div className="font-semibold text-lg">Upcoming Payments</div>
				...
				<CardContent className="p-4">
					<div className="space-y-3">
						{["skeleton-1", "skeleton-2", "skeleton-3"].map((skeletonId) => (
							<div
								key={skeletonId}
								className="flex animate-pulse items-center justify-between rounded-lg bg-muted/30 p-4"
							>
				...
				<div className="space-y-3">
					{upcomingPayments.length === 0 ? (
						<div className="flex flex-col items-center justify-center py-8 text-center">
							...
							<h3 className="mb-2 font-semibold text-lg text-success">
								All Clear!
							</h3>
